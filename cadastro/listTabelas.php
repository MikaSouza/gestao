                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Código', 'Tipo', 'Descrição', 'Data Inclusão', 'Ativo');
									$vAConfig['vACampos'] = array('TABCODIGO', 'TABTIPO', 'TABDESCRICAO', 'TABDATA_INC', 'TABSTATUS');
									$vAConfig['vATipos'] = array('int', 'varchar', 'varchar', 'datetime', 'simNao');
				...
				<div class="modal-content">
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-6">                                                      
								<label>Tipo</label>
								<select name="vSTABTIPO" id="vSTABTIPO" class="custom-select" title="Tipo">
									<option value="">------</option>
