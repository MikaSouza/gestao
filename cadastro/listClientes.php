                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Sigla', 'Cliente/Empresa', 'CPF/CNPJ', 'Representante', 'Data Inclusão', 'Data Alteração', 'Status');
									$vAConfig['vACampos'] = array('CLISEQUENCIAL', 'CLINOME', 'CLICNPJ', 'REPRESENTANTE', 'CLIDATA_INC', 'CLIDATA_ALT', 'POSICAO');
									$vAConfig['vATipos'] = array('sequencial', 'varchar', 'varchar', 'varchar', 'datetime', 'datetime', 'varchar');
