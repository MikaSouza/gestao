	...
	<?php } else { ?>
															...
															<div class="card-body">
																...
																<div class="form-group row">
																	...
																	<div class="col-sm-3">
																		...
																		<input class="form-control" name="vHCONCELULAR" id="vHCONCELULAR" type="text" title="Telefone Celular" value="<?= (isset($vRCONTATO['CONCELULAR']) ? $vRCONTATO['CONCELULAR'] : ''); ?>" maxlength="15" onKeyPress="return digitos(event, this);" onkeyup="mascara('CEL', this, event)">
																	</div>
																</div>
																<div class="form-group row">
																	<div class="col-sm-6">
																	...
																	<div class="col-sm-6">
																		<label>Site</label>
																		<input class="form-control" name="vHCONSITE" id="vHCONSITE" type="text" value="<?= (isset($vRCONTATO['CONSITE']) ? $vRCONTATO['CONSITE'] : '');  ?>">
																	</div>
																</div>
																<div class="form-group row">
																	<div class="col-sm-12">
		...
		<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modalClientesxEnderecos">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title mt-0" id="exampleModalLabel">Incluir/Alterar Dados!!</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">×</span>
						</button>
					</div>
					<div class="modal-body">
						<form class="form-parsley" action="#" method="post" name="formClientesxEnderecos" id="formClientesxEnderecos">
							<input type="hidden" id="hdn_pai_ClientesxEnderecos" name="hdn_pai_ClientesxEnderecos" value="<?= $vIOid; ?>">
							<input type="hidden" id="hdn_filho_ClientesxEnderecos" name="hdn_filho_ClientesxEnderecos" value="">
							<div class="form-group row">
								<div class="col-md-6">
									<label>CEP</label>
							...
							<div class="form-group row">
								<div class="col-md-8">
									...
									<input name="vHMENDLOGRADOURO" id="vHMENDLOGRADOURO" class="form-control divObrigatorio" maxlength="50" value="" title="Logradouro" type="text">
								</div>
								<div class="col-md-4">
									<label>Número</label>
									<input name="vHMENDNROLOGRADOURO" id="vHMENDNROLOGRADOURO" class="form-control divObrigatorio" maxlength="50" title="Número" value="" type="text" onKeyPress="return digitos(event, this)">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-8">
									<label>Complemento</label>
									<input name="vHMENDCOMPLEMENTO" id="vHMENDCOMPLEMENTO" class="form-control" maxlength="200" value="" type="text">
								</div>
								<div class="col-md-4">
									<label>Bairro</label>
							...
							<div class="form-group row">
								<div class="col-md-12 mt-3">
									<button type="button" class="btn btn-primary btn-xs  waves-effect waves-light fa-pull-right" onclick="salvarModalEnderecos('modalClientesxEnderecos','transactionEnderecos.php', 'div_enderecos', 'ClientesxEnderecos', '<?= $vIOid; ?>')">Salvar</button>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="modal-body">
						<form class="form-parsley" action="#" method="post" name="formClientesxContatos" id="formClientesxContatos">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<label>Senha Portal</label><a href="javascript:void(0);" id="gerarSenhaBtn"> (Gerarsenha)</a>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<label>Telefone Celular</label>
									<input type="text" id="vHMCONCELULAR" name="vHMCONCELULAR" class="form-control" maxlength="15" title="Telefone Celular" value="" onKeyPress="return digitos(event, this);" onkeyup="mascara('CEL', this, event)" />
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-6">
