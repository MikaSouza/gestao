...
if (isset($_POST['hdn_metodo_search']) && $_POST['hdn_metodo_search'] == 'ClientesxFaturamento')
	listClientesxFaturamento($_POST['pIOID'], 'ClientesxFaturamento');

if (isset($_GET['hdn_metodo_fill']) && $_GET['hdn_metodo_fill'] == 'fill_ClientesxFaturamento')
	fill_ClientesxFaturamento($_GET['CHGCODIGO'], $_GET['formatoRetorno']);

if (isset($_POST['method']) && $_POST['method'] == 'incluirClientesxFaturamento'){
	...
	echo insertUpdateClientesxFaturamento($_POSTCHG, 'N');
}
...
function insertUpdateClientesxFaturamento($_POSTDADOS, $pSMsg = 'N'){
	$dadosBanco = array(
...
function fill_ClientesxFaturamento($pOid, $formatoRetorno = 'array' ){
	$SqlMain = 	"SELECT
	                *
	            FROM
...
function listClientesxFaturamento($vIOIDPAI, $tituloModal){
	$sql = "SELECT
	...
	$vAConfig['TRANSACTION'] = "transactionClientesxFaturamento.php";
	$vAConfig['DIV_RETORNO'] = "div_historico";
	$vAConfig['FUNCAO_RETORNO'] = "ClientesxFaturamento";
