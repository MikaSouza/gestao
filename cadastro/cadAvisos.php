                                    ...
                                    <form class="form-parsley" action="#" method="post" name="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>" id="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>">
										...
										<div class="form-group row">
											<div class="col-md-6">                                                      
												...
												<input class="form-control obrigatorio" name="vSAVITITULO" id="vSAVITITULO" type="text" value="<?= ($vIOid > 0 ? $vROBJETO['AVITITULO'] : ''); ?>" title="Título" >
											</div>											
										</div>
										<div class="form-group row">
											<div class="col-md-6">
												...
												<input class="form-control obrigatorio" title="Data Início" name="vDAVIDATAINICIAL" id="vDAVIDATAINICIAL" value="<?= $vROBJETO['AVIDATAINICIAL']; ?>" type="date" >
											</div>
											<div class="col-md-6">
												<label>Data Final
													<small class="text-danger font-13">*</small>
										...
										<div class="form-group row">
											<div class="col-md-12">                                                      
												...
												<textarea class="form-control" id="vSAVIDESCRICAO" name="vSAVIDESCRICAO" title="Descrição"><?= $vROBJETO['AVIDESCRICAO']; ?></textarea>
											</div>
										</div>										
										<div class="form-group row">
											<div class="col-sm-3">
