...
function fillClientesxContatos(pICONCODIGO) {
	var vSUrl = 'transaction/transactionContatos.php?hdn_metodo_fill=fill_ContatosPadrao&vICONCODIGO=' + pICONCODIGO + '&formatoRetorno=json';
	$.getJSON(vSUrl, function (json) {
		for (var i in json) {
