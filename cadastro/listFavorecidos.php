                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Sigla', 'Nome Fantasia', 'CPF/CNPJ', 'Data Inclusão', 'Data Alteração', 'Status');
									$vAConfig['vACampos'] = array('FAVCODIGO', 'FAVNOMEFANTASIA', 'CNPJCPF', 'FAVDATA_INC', 'FAVDATA_ALT', 'FAVSTATUS');
									$vAConfig['vATipos'] = array('sequencial', 'varchar', 'varchar', 'datetime', 'datetime', 'simNao');
				...
				<div class="modal-content">
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-6">                                                      
								<label>SIGLA</label>
								<input class="form-control classnumerico" name="vIFAVSEQUENCIAL" id="vIFAVSEQUENCIAL" type="text" value="" title="SIGLA" >
							</div> 
							<div class="col-md-6">                                                      
