                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Código', 'Nome', 'Data Inclusão', 'Data Alteração', 'Ativo');
									$vAConfig['vACampos'] = array('PXSCODIGO', 'PXSNOME', 'PXSDATA_INC', 'PXSDATA_ALT', 'PXSSTATUS');
									$vAConfig['vATipos'] = array('sequencial', 'varchar', 'datetime', 'datetime', 'simNao');
				...
				<div class="modal-content">
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-6">                                                      
								<label>Nome</label>
								<input class="form-control" name="vSPXSNOME" id="vSPXSNOME" type="text" value="" title="Nome" >
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-6">
