                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos']     = array('Mês/Ano', 'Colaborador', 'Departamento/Setor', 'Quantidade (dia)', 'Valor Unitário', 'Valor Compra', 'Data Envio');
									$vAConfig['vACampos']      = array('PERIODO', 'NOMEDEUSUARIO', 'DEPARTAMENTO', 'UXVQTDE', 'UXVVALOR', 'LUVVALOR', 'LUVDATA_INC');
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						...
						<div class="form-group row">
							<div class="col-md-3">
								...
								<select class="form-control" name="vILUVMES" id="vILUVMES" title="Mês Competência">
									<option value="">------</option>
							...
							<div class="col-md-3"> 
								...
								<input type="text" class="form-control" name="vILUVANO" id="vILUVANO" title="Ano Competência" value="<?= date('Y'); ?>" />
							</div>	
						</div>
						<div class="form-group row">
