                                        ...
                                        <div class="tab-pane active p-3" id="home-1" role="tabpanel">
											<div class="form-group row">
												<div class="col-md-2">
													...
													<select class="form-control obrigatorio" name="vILURMES" id="vILURMES" title="Mês Competência">
												...
												<div class="col-md-2"> 
													...
													<input type="text" class="form-control obrigatorio" name="vILURANO" id="vILURANO" title="Ano Competência" value="<?= $vIANO; ?>" />
												</div>		
												<div class="col-md-6">
													<label>Filial
														<small class="text-danger font-13">*</small>
											...
											<div class="form-group row">
												...
												listLancamentosUsuariosxRecebimentosFilhos($arrayDados);
												?>
											</div>   
