...
$vAConfiguracaoTela = configuracoes_menu_acesso(2003);
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos']     = array('Colaborador', 'Departamento', 'Vale', 'Itinerário', 'Valor Unitário', 'Quantidade dia(s)');
									$vAConfig['vACampos']      = array('NOMEDEUSUARIO', 'DEPARTAMENTO', 'VXTNOME', 'VXTITINERARIO', 'UXVVALOR', 'UXVQTDE');
									$vAConfig['vATipos']       = array('varchar', 'varchar', 'varchar', 'varchar', 'monetario', 'int');
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-12">                                                      
								...
								<input class="form-control" name="vSUSUNOME" id="vSUSUNOME" type="text" value="" title="Nome Colaborador" >
							</div>							
						</div>													
						<div class="form-froup row">
							...
							<div class="col-md-6">
								...
								<select class="custom-select" id="vIVXTCODIGO" name="vIVXTCODIGO" title="Vale - Itinerário">
									<option value></option>
