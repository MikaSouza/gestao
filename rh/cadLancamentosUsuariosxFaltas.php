                                        ...
                                        <div class="tab-pane active p-3" id="home-1" role="tabpanel">
											<div class="form-group row">
												<div class="col-md-2">
													...
													<select class="form-control obrigatorio" name="vILUFMES" id="vILUFMES" title="Mês Competência">
												...
												<div class="col-md-2"> 
													...
													<input type="text" class="form-control obrigatorio" name="vILUFANO" id="vILUFANO" title="Ano Competência" value="<?= $vIANO; ?>" />
												</div>														
											</div>
											<div class="form-group row">
												...
												listLancamentosUsuariosxFaltasFilhos($arrayDados);
												?>
											</div>   
