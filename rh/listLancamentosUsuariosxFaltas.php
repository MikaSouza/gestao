...
$vAConfiguracaoTela = configuracoes_menu_acesso(2006);
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos']     = array('Mês/Ano', 'Colaborador', 'Departamento/Setor', 'Quantidade dia(s)', 'Data Envio');
									$vAConfig['vACampos']      = array('PERIODO', 'NOMEDEUSUARIO', 'DEPARTAMENTO', 'LUFDIAS', 'LUFDATA_INC');
									$vAConfig['vATipos']       = array('varchar', 'varchar', 'varchar', 'int', 'datetime');
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						...
						<div class="form-group row">
							<div class="col-md-3">
								...
								<select class="form-control" name="vILUFMES" id="vILUFMES" title="Mês Competência">
									<option value="">------</option>
							...
							<div class="col-md-3"> 
								...
								<input type="text" class="form-control" name="vILUFANO" id="vILUFANO" title="Ano Competência" value="<?= date('Y'); ?>" />
							</div>	
						</div>
						<div class="form-group row">
