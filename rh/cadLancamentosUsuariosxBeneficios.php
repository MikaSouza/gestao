...
<html lang="pt-br">
    ...
    <body onload="gerarGridJSON('transactionLancamentosUsuariosxBeneficios.php', 'div_colaboradores', 'LancamentosUsuariosxBeneficios', '<?= $vIOid;?>');">
                                        ...
                                        <div class="tab-pane active p-3" id="home-1" role="tabpanel">
											<div class="form-group row">
												<div class="col-md-2">
													...
													<select class="form-control obrigatorio" name="vILUBMES" id="vILUBMES" title="MÊS">
												...
												<div class="col-md-2"> 
													...
													<input type="text" class="form-control obrigatorio" name="vILUBANO" id="vILUBANO" title="ANO" value="<?= $vIANO; ?>" />
												</div>												
											</div>
											<div class="form-group row">
