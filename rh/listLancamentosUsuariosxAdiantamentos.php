                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos']     = array('Mês/Ano', 'Colaborador', 'Departamento/Setor', 'Valor Adiantamento', 'Data Envio');
									$vAConfig['vACampos']      = array('PERIODO', 'NOMEDEUSUARIO', 'DEPARTAMENTO', 'LUAVALOR', 'LUADATA_INC');
									$vAConfig['vATipos']       = array('varchar', 'varchar', 'varchar', 'monetario', 'datetime');
