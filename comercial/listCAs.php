                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Número CA.', 'Data', 'Sigla/Empresa', 'Representante', 'Valor', 'Data Inclusão', 'Ativo');
									$vAConfig['vACampos'] = array('CXCNUMEROCA', 'CXCDATA', 'CLINOME', 'REPRESENTANTE', 'CXCVALOR', 'CXCDATA_INC', 'CXCSTATUS');
									$vAConfig['vATipos'] = array('int', 'date', 'varchar', 'varchar', 'monetario', 'datetime', 'simNao');
				...
				<div class="modal-content">
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
                            <div class="col-md-3">                                                      
								<label>NOME CLIENTE</label></br></br>
								<input class="form-control" name="vSCLINOME" id="vSCLINOME" type="text" title="NOME CLIENTE">
                            </div>
                            <div class="col-md-3">                                                      
								<label>NÚMERO DA AB</label></br></br>
								<input class="form-control" name="vICXBNUMEROAB" id="vICXBNUMEROAB" type="text" title="NÚMERO DA AB">
							</div>
							<div class="col-md-3">                                                      
								<label>SIGLA CLIENTE</label></br></br>
							...
							<div class="col-md-3">                                                      
								...
								<input class="form-control" name="vSCLINOME" id="vSCLINOME" type="text" title="NÚMERO CONSULTOR">
							</div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">                                                        
								<label>MARCA/TÍTULO</label><!-- FALTOU AQUI -->
								<input class="form-control" name="vSCLICNPJ" id="vSCLICNPJ" type="text" title="MARCA/TÍTULO">
                            </div>
                            <div class="col-md-4">                                                        
								<label>NÚMERO</label>
								<input class="form-control" name="vICXCNUMEROCA" id="vICXCNUMEROCA" type="text" title="NÚMERO">
							</div>
                        </div>	
						<div class="form-group row">
							<div class="col-md-6">
