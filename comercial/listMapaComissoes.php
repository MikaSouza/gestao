...
$vAConfiguracaoTela = configuracoes_menu_acesso();
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-4">                                                      
								...
								<input class="form-control classnumerico" name="vICLISEQUENCIAL" id="vICLISEQUENCIAL" type="text" value="" title="CONSULTOR" >
							</div> 
						</div>	
						<div class="form-group row">
							<div class="col-md-6">
