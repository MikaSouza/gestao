                                    ...
                                    <form class="form-parsley" action="#" method="post" name="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>" id="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>">
										...
										<div class="form-group row">
											<div class="col-md-6">
												...
												<input type="text" class="form-control is-invalid obrigatorio" name="vSGCNNOME" id="vSGCNNOME" maxlength="100" title="NOME" value="<?= $vROBJETO['GCNNOME']; ?>"/>
											</div>
										</div>
										<div class="form-group row">
											<div class="col-md-2">
											...
											<div class="col-md-2">
												<label>ID</label>
												<input type="text" class="form-control" name="vH<?= $vAConfiguracaoTela['MENPREFIXO'];?>" id="vH<?= $vAConfiguracaoTela['MENPREFIXO'];?>CODIGO" title="ID" value="<?= adicionarCaracterLeft($vROBJETO['GCNCODIGO'], 6); ?>" readonly/>												
											</div>
										</div>
