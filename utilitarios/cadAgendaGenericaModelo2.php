...
include_once __DIR__.'/transaction/transactionAgendaGenericaModelo2.php';
...
<html lang="pt-br">
	...
	<?php $vAConfiguracaoTela['MENTITULO'] = 'Agenda Aberta 2';
                                ...
                                <div class="card-body">
									...
									<form class="form-parsley" action="#" method="post" name="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>" id="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>">
										...
										<div class="wrapper2">
											...
											<?php
												$vResult = fill_AgendaGenericaModelo2MesAno($vIANO, $vIMES, $vICLIRESPONSAVEL);
												//pre($vResult['dados']);
												$atividades = array(); 
		...
		<script>
			...
			function imprimirAgenda(vIMES, vIANO, vICLIRESPONSAVEL){
				window.open(
					"imprimirAgendaGenericaModelo2.php?" +
			...
			function gerarExcelAgenda(vIMES, vIANO, vICLIRESPONSAVEL){
				...
				window.open(
					"excelAgendaGenericaModelo2.php?" +
						"vIMES=" + vIMES + "&vIANO=" + vIANO + "&vICLIRESPONSAVEL=" + vICLIRESPONSAVEL,
					"popup",
					"toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,top=0,left=0,width=" +
						$(window).width() +
