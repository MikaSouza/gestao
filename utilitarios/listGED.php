...
$vAConfiguracaoTela = configuracoes_menu_acesso(1994);
				...
				<div class="row">
					<div class="col-12">
						...
						<?php
								...
								$vAConfig['vATitulos'] 	= array('Data', 'Usuário', 'Origem', 'Tipo', 'Arquivo', 'Link');
								$vAConfig['vACampos'] 	= array('GEDDATA_INC', 'USUNOME', 'MENTITULO', 'TIPO', 'GEDNOMEARQUIVO', 'LINK');
								$vAConfig['vATipos'] 	= array('datetime', 'varchar', 'varchar', 'varchar', 'varchar', 'varchar');
