			...
			<div class="auth-page">
				...
				<div class="row mt-2 px-5">
					...
					<div class="col-10 text-center">
						<a href="http://teraware.com.br" class="" target="_blank" title="Teraware 10 Anos - ERP | Sistemas Web | ERP Customizados | Projetos Especiais" alt="Teraware - ERP | Sistemas Web | ERP Customizados | Projetos Especiais">
