...
$vAConfiguracaoTela = configuracoes_menu_acesso(1981);
...
<html lang="pt-br">
	...
	<?php } ?>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active p-3" id="home-1" role="tabpanel">
											...
											<div class="form-group row">
												<div class="col-sm-3">
													<label>Pasta</label>
													<input class="form-control is-invalid obrigatorio classnumerico" title="Pasta" name="vICODPASTA" id="vICODPASTA" type="text" value="<?php if(isset($vIOid)){ echo $vROBJETO['AVEPASTA']; }?>" required>
												</div>                                        
												<div class="col-sm-3">
													<label>Processo</label>
													<input class="form-control is-invalid obrigatorio classnumericobig" title="Processo" name="vIAVEPROCESSO" id="vIAVEPROCESSO" type="text" value="<?php if(isset($vIOid)){ echo $vROBJETO['AVEPROCESSO']; }?>" required>
												</div>        
												<div class="col-sm-3">	
													<label>Data Lançamento
														<small class="text-danger font-13">*</small>
													</label>
													<input class="form-control obrigatorio" title="Data Lançamento" name="vDAVEDATAPROCESSO" id="vDAVEDATAPROCESSO" value="<?= $vROBJETO['AVEDATAPROCESSO'];  ?>" type="date" >
												</div>  	
											</div>
											<div class="form-group row">
												<div class="col-md-5">                                                      
											...
											<div class="form-group row">																						
												<div class="col-md-6">
													...
													<select name="vIAVEORGAO" id="vIAVEORGAO" class="custom-select obrigatorio" title="Tipo">
														<option value="">  -------------  </option>
														<?php foreach (comboTabelas('PROCESSOS - ORGAO') as $tabelas): ?>                                                            
															<option value="<?php echo $tabelas['TABCODIGO']; ?>" <?php if ($vROBJETO['AVEORGAO'] == $tabelas['TABCODIGO']) echo "selected='selected'"; ?>><?php echo $tabelas['TABDESCRICAO']; ?></option>
														<?php endforeach; ?>
													</select>                                                    
												</div>
												<div class="col-md-6">
													<label>Motivo Cancelamento</label>
													<select name="vIAVEMOTIVOCANCELAMENTO" id="vIAVEMOTIVOCANCELAMENTO" class="custom-select" title="Motivo Cancelamento">
														<option value="">  -------------  </option>
														<?php foreach (comboTabelas('PROCESSOS - CANCELAMENTO') as $tabelas): ?>                                                            
															<option value="<?php echo $tabelas['TABCODIGO']; ?>" <?php if ($vROBJETO['AVEMOTIVOCANCELAMENTO'] == $tabelas['TABCODIGO']) echo "selected='selected'"; ?>><?php echo $tabelas['TABDESCRICAO']; ?></option>
														<?php endforeach; ?>
													</select> 		
												</div>
											</div>
											<div class="form-group row">
												<div class="col-md-12">                                                      
													...
													<input title="Marca/Título" type="text" name="vSAVETITULO" id="vSAVETITULO" class="form-control obrigatorio" value="<?php echo $vROBJETO['AVETITULO']; ?>" />												
												</div> 													
											</div>											
											<div class="form-group row">
												<div class="col-md-12">
													<label>Observações</label>
													<textarea class="form-control" id="vSAVEOBSERVACAO" name="vSAVEOBSERVACAO" rows="3"><?= $vROBJETO['AVEOBSERVACAO']; ?></textarea>
												</div>	
											</div>
		...
		<script src="js/cadAverbacaoContratosINPI.js"></script>
