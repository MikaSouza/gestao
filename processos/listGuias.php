                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Clientes', 'Processo', 'Data de Vencimento', 'Data de Pagamento', 'Valor', 'Pagador', 'Procedimento', 'CA/FR', 'Nº NF / Recibo', 'GED', 'Data Inclusão', 'Ativo');
									$vAConfig['vACampos'] = array('CLINOME', 'GUIPROCESSO', 'GUIDATAVENCIMENTO', 'GUIDATAPAGAMENTO', 'GUIVALOR', 'PAGADOR', 'TABDESCRICAO',	'GUICAFR', 'GUINRONOTARECIBO', 'GED', 'GUIDATA_INC', 'GUISTATUS');
									$vAConfig['vATipos'] = array('varchar', 'varchar', 'date', 'date', 'monetario', 'varchar', 'varchar', 'varchar', 'varchar', 'varchar', 'datetime', 'simNao');
