                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos']     = array('Código Classe', 'Grupo', 'Descrição', 'Data Inclusão', 'Data Alteração', 'Ativo');
									$vAConfig['vACampos']      = array('CLACODCLASSE', 'CLAGRUPO', 'CLADESCRICAO', 'CLADATA_INC', 'CLADATA_ALT', 'CLASTATUS');
									$vAConfig['vATipos']       = array('varchar', 'varchar', 'varchar', 'datetime', 'datetime', 'simNao');
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-12">                                                      
								...
								<input class="form-control" name="vSCLADESCRICAO" id="vSCLADESCRICAO" type="text" value="" title="Descrição" >
							</div>							
						</div>	
						<div class="form-group row">
							<div class="col-md-12">                                                      
								<label>Nota Explicativa</label>
								<input class="form-control" name="vSCLANOTAEXPLICATIVA" id="vSCLANOTAEXPLICATIVA" type="text" value="" title="Nota Explicativa" >
							</div>							
						</div>	
						<div class="form-group row">
							<div class="col-md-6">                                                        
								<label>Classe</label>
								<input class="form-control" name="vICLACODCLASSE" id="vICLACODCLASSE" type="text" title="Classe" value="" >
							</div> 
							<div class="col-md-6">                                                      
								<label>Grupo</label>
								<input class="form-control" name="vICLAGRUPO" id="vICLAGRUPO" type="text" value="" title="Grupo" >
							</div>							
						</div>													
						<div class="form-group row">
							<div class="col-md-6">
