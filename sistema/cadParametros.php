...
$vAConfiguracaoTela = configuracoes_menu_acesso(116);
                                    ...
                                    <form class="form-parsley" action="#" method="post" name="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>" id="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>">
										...
										<div class="form-group row">
											<div class="col-md-6">
												...
												<input type="text" class="form-control is-invalid obrigatorio" name="vSPARTIPO" id="vSPARTIPO" maxlength="250" title="Tipo" value="<?= $vROBJETO['PARTIPO']; ?>"/>
											</div>
											<div class="col-md-6">
												<label>Descrição
													<small class="text-danger font-13">*</small>
												</label>
												<input type="text" class="form-control is-invalid obrigatorio" name="vSPARDESCRICAO" id="vSPARDESCRICAO" maxlength="250" title="Descrição" value="<?= $vROBJETO['PARDESCRICAO']; ?>"/>
											</div>
                                        </div>
                                        <div class="form-group">
                                            <label>Observações</label>
                                            <textarea class="form-control" id="vSPAROBS" name="vSPAROBS" rows="3"><?= $vROBJETO['PAROBS']; ?></textarea>
                                        </div>
										<div class="form-group row">
											<div class="col-md-2">
