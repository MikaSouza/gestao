                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfig['vATitulos'] = array('Código', 'Código Aux.', 'Nome', 'Unidade', 'Grupo 1', 'Quantidade Atual', 'Data Inclusão', 'Data Alteração', 'Ativo');
									$vAConfig['vACampos'] = array('PROCODIGO', 'PROCODIGOAUX', 'PRONOME', 'UNIDADE', 'GRUPO', 'PROQTDEATUAL', 'PRODATA_INC', 'PRODATA_ALT', 'PROSTATUS');
									$vAConfig['vATipos'] = array('sequencial', 'varchar', 'varchar', 'int', 'int', 'int', 'datetime', 'datetime', 'simNao');
				...
				<div class="modal-content">
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							...
							<div class="col-md-6">                                                        
								<label>GRUPO 1</label>								
								<select name="vIPROGRUPO1" id="vIPROGRUPO1" class="custom-select" title="GRUPO 1">
									<option value="">  -------------  </option>									
