...
function comboDepartamentos(vIUSUCODIGO, vSNOME) {

    jQuery.ajax({
        async: true,
        type: "GET",
        url: "../rh/combos/comboDepartamentos.php",
        data: {
            vIUSUCODIGO: vIUSUCODIGO,
			vSNOME: vSNOME,
            method: 'fillDepartamentos'
        },
        success: function(resposta){
            document.getElementById('div_departamento').innerHTML = resposta;
            return true;
        },
        error: function(msg) {
