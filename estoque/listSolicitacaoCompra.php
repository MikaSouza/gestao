                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									...
									$vAConfiguracaoTela['FILTROS']['vSSOCPOSICAO'] = 'AGUARDANDO';
									$vAConfig['vATitulos']  = array('Número', 'Fornecedor', 'Solicitante', 'Produto - Quantidade Solicitada', 'Posição', 'Data Solicitação');
									$vAConfig['vACampos']   = array('SOCCODIGO', 'FAVNOMEFANTASIA','SOLICITANTE', 'PRODUTO', 'SOCPOSICAO', 'SOCDATA_INC');
					...
					<form class="form-parsley" action="#" method="post" name="formPesquisar" id="formPesquisar">
						<div class="form-group row">
							<div class="col-md-6">                                                      
								...
								<input class="form-control" name="vSFAVORECIDO" id="vSFAVORECIDO" type="text" value="" title="Fornecedor" >
							</div>		
							<div class="col-md-6">                                                      
								<label>Produto</label>
						...
						<div class="form-group row">
							<div class="col-md-6">
								...
								<select class="form-control" id="vSSOCPOSICAO" name="vSSOCPOSICAO">
									<option value="">-------------</option>
