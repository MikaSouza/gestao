                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card card-eco">
                                <div class="card-body">
                                    <h4 class="title-text mt-0">Novos Clientes</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="card card-eco">
                                <div class="card-body">
                                    <h4 class="title-text mt-0">Novas Oportunidades</h4>
                                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-lg-3">
                            <div class="card card-eco">
                                <div class="card-body">
                                    <h4 class="title-text mt-0">Novas Solicitações</h4>
                                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-lg-3">
                            <div class="card card-eco">
                                <div class="card-body">
                                    <h4 class="title-text mt-0">Fechamentos</h4>
                                    <div class="d-flex justify-content-between">
