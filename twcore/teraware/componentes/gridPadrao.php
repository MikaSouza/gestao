...
<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
	...
	if($vAConfiguracaoTela['MENTITULOFUNC'] <> 'N'){
		...
		<tr>
			...
			if ($vAConfiguracaoTela['BTN_NOVO_REGISTRO'] == '') { ?>
			<td align="center">
				<a href="<?= $vAConfiguracaoTela['MENARQUIVOCAD'];?>?oid=<?= $arrayGrid[$vAConfiguracaoTela['MENPREFIXO'].'CODIGO'];?>&method=update" class="mr-2" title="Editar Registro" alt="Editar Registro"><i class="fas fa-edit text-info font-16"></i></a>
				<a href="#" onclick="excluirRegistroGrid('<?= $arrayGrid[$vAConfiguracaoTela['MENPREFIXO'].'CODIGO']?>', '<?= $vAConfiguracaoTela['MENARQUIVOTRAN'];?>', 'excluirPadrao', '<?= $vAConfiguracaoTela['MENCODIGO'];?>')" title="Excluir Registro" alt="Excluir Registro"><i class="fas fa-trash-alt text-danger font-16"></i></a>
			</td>
			<?php } ?>
		</tr>
