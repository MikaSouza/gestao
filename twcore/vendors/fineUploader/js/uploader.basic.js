qq.FineUploaderBasic = function(o){
	...
	//var limit_MB = $.isNumeric($("#emp_limite").val()) ? $("#emp_limite").val() : 2;
	//limit_MB *= 1024 * 1024;
	
	
	
	var limit_base = $("#emp_limite").val();
	
	var limite_cliente = limit_base !== "" && $.isNumeric(limit_base) ? limit_base : 2;
	
	var limit_MB = limite_cliente * 1024 * 1024;
    ...
    this._options = {
        ...
        autoUpload: true,
        request: {
            endpoint: '../ajax_upload/classAjaxUpload.php',
            params: {},
            paramsInBody: false,
            customHeaders: {},
            forceMultipart: true,
        ...
        validation: {
            allowedExtensions: ['jpeg', 'jpg', 'gif', 'png', 'bmp', 'txt', 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'odt', 'ods', 'odp', 'rar', 'csv', 'eml', 'xml'],
            sizeLimit: limit_MB,
            minSizeLimit: 0,
        ...
        messages: {
            typeError: "Não é aceita a extensão do arquivo {file}. Extensões aceitas: {extensions}.",
            sizeError: "O arquivo {file} é muito grande, o tamanho máximo para upload é {sizeLimit}.",
            minSizeError: "O arquivo {file} é muito pequeno, o tamanho mínimo para upload é {minSizeLimit}.",
            emptyError: "O arquivo {file} está em branco, por favor selecione outro arquivo e tente novamente.",
            noFilesError: "Não existem arquivos para o upload.",
            onLeave: "Os arquivos estão sendo carregados, se você cancelar o upload não será realizado."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
