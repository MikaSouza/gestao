...
class ToolsNFePHP extends CommonNFePHP
{
     ...
     * @var string
     */
    protected $priKEY = '/var/www/html/marpa_intranet/nfe/marpa_private.pem';
    protected $pubKEY = '/var/www/html/marpa_intranet/nfe/marpa_public.pem';
    protected $certKEY = '/var/www/html/marpa_intranet/nfe/marpa_private.pem';
    /*
    switch ($_SESSION['empresa']) {
            default:
            case '1':
                protected $priKEY = '/var/www/marpa_intranet/nfe/marpa_private.pem';
                protected $pubKEY = '/var/www/marpa_intranet/nfe/marpa_public.pem';
                protected $certKEY = '/var/www/marpa_intranet/nfe/marpa_private.pem';
            break;
            case '2':
                protected $priKEY = '/var/www/marpa_intranet/nfe/oito_private.pem';
                protected $pubKEY = '/var/www/marpa_intranet/nfe/oito_public.pem';
                protected $certKEY = '/var/www/marpa_intranet/nfe/oito_private.pem';
            break;
            case '3':
                protected $priKEY = '/var/www/marpa_intranet/nfe/virtual_private.pem';
                protected $pubKEY = '/var/www/marpa_intranet/nfe/virtual_public.pem';
                protected $certKEY = '/var/www/marpa_intranet/nfe/virtual_private.pem';
            break;
        }*/
        //if($_SESSION['empresa']==1) {
            ...
            //protected $certKEY = '/var/www/marpa_intranet/nfe/marpa_private.pem';
        //}
    //protected $priKEY = '/var/www/clients/client1/web1/web/nfe/private.pem';
    /**
     * pubKEY
     ...
     * @var string
     */
    //protected $certKEY = '/var/www/clients/client1/web1/web/nfe/private.pem';
    /**
     * empName
     ...
     * @var string
     */
    private $URLPortal = 'https://nfse-hom.procempa.com.br/bhiss-ws/nfse?wsdl';
    /**
     * aliaslist
    ...
    public function signXML($docxml, $tagid = '',$tagid2) {
        try {
            if ($tagid == '') {
   ...
   //          switch ($_SESSION['empresa']) {
            //  default:
            //  case '1':
            //      $this->priKEY = '/var/www/html/marpa_intranet/nfe/marpa_private.pem';
            //      $this->pubKEY = '/var/www/html/marpa_intranet/nfe/marpa_public.pem';
            //      $this->certKEY = '/var/www/html/marpa_intranet/nfe/marpa_private.pem';
            //  break;
            //  case '2':
            //      $this->priKEY = '/var/www/html/marpa_intranet/nfe/oito_private.pem';
            //      $this->pubKEY = '/var/www/html/marpa_intranet/nfe/oito_public.pem';
            //      $this->certKEY = '/var/www/html/marpa_intranet/nfe/oito_private.pem';
            //  break;
            //  case '3':
            //      $this->priKEY = '/var/www/html/marpa_intranet/nfe/virtual_private.pem';
            //      $this->pubKEY = '/var/www/html/marpa_intranet/nfe/virtual_public.pem';
            //      $this->certKEY = '/var/www/html/marpa_intranet/nfe/virtual_private.pem';
            //  break;
            // }
            ...
            fclose($filep);
            $pkeyid = openssl_get_privatekey($priv_key,'15011221');
            ...
            $node2 = $xmldoc->getElementsByTagName($tagid2)->item(0);
            if (!isset($node)) {
                $msg = "A tag < $tagid > não existe no XML!!";
                throw new nfephpException($msg);
            }
            ...
            if($tagid=='Rps') {
                $Signature->setAttribute("Id", "Ass_rps:".$Id);
            }
            if($tagid=='EnviarLoteRpsEnvio') {
                $Signature->setAttribute("Id", "Ass_Lote");
            }
            $node2->appendChild($Signature);
