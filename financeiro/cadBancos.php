...
$vAConfiguracaoTela = configuracoes_menu_acesso(4);
                                    ...
                                    <form class="form-parsley" action="#" method="post" name="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>" id="form<?= $vAConfiguracaoTela['MENTITULOFUNC'];?>" onSubmit="return validarForm();">
										...
										<div class="form-group row">
                                            <div class="col-md-6">
												...
												<input class="form-control obrigatorio" title="Código BACEN" type="text" id="vSBACCODIGOBACEN" name="vSBACCODIGOBACEN" maxlength="5" value="<?= $vROBJETO['BACCODIGOBACEN']; ?>" />											
                                            </div>	
                                            <div class="col-md-6">
												<label>Banco
													<small class="text-danger font-13">*</small>
												</label>
												<input class="form-control obrigatorio" title="Banco" type="text" id="vSBACBANCO" name="vSBACBANCO" maxlength="200" value="<?= $vROBJETO['BACBANCO']; ?>" />											
											</div>										
                                        </div>
										<div class="form-group row">
											<div class="col-md-2">
